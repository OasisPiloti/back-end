package oasis.piloti.errors;


import oasis.piloti.API.ApiBuilder;
import oasis.piloti.errors.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> unknownError(Exception exception) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(ApiBuilder.error(exception.getMessage()));
    }
}